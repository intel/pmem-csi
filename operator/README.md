...
| metadata | [ObjectMeta](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status) | Object metadata, name used for CSI driver and as prefix for sub-objects |
