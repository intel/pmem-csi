...
``` console
$ sudo docker run --privileged --rm -u 0:0 docker.io/intel/pmem-csi-driver:v1.0.2 ipmctl help
...
``` console
$ kubectl create -f https://github.com/intel/pmem-csi/raw/v1.0.2/deploy/crd/pmem-csi.intel.com_pmemcsideployments.yaml
```

Then install the PMEM-CSI operator itself:

``` console
$ kubectl create -f https://github.com/intel/pmem-csi/raw/v1.0.2/deploy/operator/pmem-csi-operator.yaml
```
...
``` console
$ kubectl apply -f https://github.com/intel/pmem-csi/raw/v1.0.2/deploy/common/pmem-storageclass-late-binding.yaml
storageclass.storage.k8s.io/pmem-csi-sc-late-binding created
```

Then request a volume which uses that class:
``` console
$ kubectl apply -f https://github.com/intel/pmem-csi/raw/v1.0.2/deploy/common/pmem-pvc-late-binding.yaml
...
``` console
$ kubectl apply -f https://github.com/intel/pmem-csi/raw/v1.0.2/deploy/common/pmem-app-late-binding.yaml
...
Pod Template:
  ...
  Containers:
   pmem-driver:
    Image:      172.17.42.1:5001/pmem-csi-driver:v1.0.2
    Port:       <none>
    Host Port:  <none>
    Command:
